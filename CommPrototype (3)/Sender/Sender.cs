///////////////////////////////////////////////////////////////
// Sender.cs :The operations required for messahe sending    //
// ver 2.2                                                   //
...
/* Maintainence
* ---------------
* Required Files: ICommService.cs,BlockingQueue.c,
*                 Utilities.cs
*
        ...
        ThreadStart sendThreadProc = () =>
        {
          while (true)           {
            try             {
              ...
              continue;             }           }         };   Thread t = new Thread(sendThreadProc);  // start the sendThread
        t.IsBackground = true;
        t.Start();       };
